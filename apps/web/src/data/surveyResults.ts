...
> = {
  ...
  diputados: {
    ...
    ancash: [
      { name: 'Zulema Barrenechea', party: 'Renovación Popular', color: COLORS.renovacionPopular, percentage: 8, photoUrl: PHOTOS.barrenechea },
      { name: 'Mary Melgarejo', party: 'Alianza Para el Progreso', color: COLORS.alianzaProgreso, percentage: 6, photoUrl: PHOTOS.melgarejo },
      { name: 'Jesús Veliz', party: 'Fuerza Popular', color: COLORS.fuerzaPopular, percentage: 6, photoUrl: PHOTOS.veliz },
      { name: 'María Gamarra', party: 'Avanza País', color: COLORS.avanzaPais, percentage: 6, photoUrl: PHOTOS.gamarra },
      { name: 'Pamela Toro', party: 'País para Todos', color: COLORS.paisParaTodos, percentage: 4, photoUrl: PHOTOS.toro },
    ],
  },
  senadores: {
    'san-martin': [
...
> = {
  ...
  diputados: {
    ...
    ancash: [
      { province: 'SANTA', label: 'Jesús Veliz', partyName: 'Fuerza Popular', partyColor: COLORS.veliz, percentage: 16, photoUrl: PHOTOS.veliz, center: [-78.29, -9.02] },
      { province: 'CASMA', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 21, photoUrl: PHOTOS.barrenechea, center: [-78.16, -9.48] },
      { province: 'HUARMEY', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 22, photoUrl: PHOTOS.melgarejo, center: [-77.88, -10.12] },
      { province: 'HUARAZ', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.69, -9.57] },
      { province: 'HUARI', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 8, photoUrl: PHOTOS.melgarejo, center: [-77.04, -9.41] },
      { province: 'YUNGAY', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.71, -9.18] },
      { province: 'CARHUAZ', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 8, photoUrl: PHOTOS.melgarejo, center: [-77.56, -9.28] },
      { province: 'BOLOGNESI', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.02, -9.98] },
      { province: 'PALLASCA', label: 'María Gamarra', partyName: 'Avanza País', partyColor: COLORS.gamarra, percentage: 8, photoUrl: PHOTOS.gamarra, center: [-77.91, -8.35] },
      { province: 'CORONGO', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.89, -8.58] },
      { province: 'HUAYLAS', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 8, photoUrl: PHOTOS.melgarejo, center: [-77.85, -8.94] },
      { province: 'POMABAMBA', label: 'María Gamarra', partyName: 'Avanza País', partyColor: COLORS.gamarra, percentage: 8, photoUrl: PHOTOS.gamarra, center: [-77.44, -8.74] },
      { province: 'SIHUAS', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.58, -8.5] },
      { province: 'ANTONIO RAYMONDI', label: 'Pamela Toro', partyName: 'País para Todos', partyColor: COLORS.toro, percentage: 7, photoUrl: PHOTOS.toro, center: [-77.07, -9.13] },
      { province: 'CARLOS FERMIN FITZCARRALD', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 8, photoUrl: PHOTOS.melgarejo, center: [-77.23, -9.04] },
      { province: 'MARISCAL LUZURIAGA', label: 'María Gamarra', partyName: 'Avanza País', partyColor: COLORS.gamarra, percentage: 8, photoUrl: PHOTOS.gamarra, center: [-77.37, -8.9] },
      { province: 'AIJA', label: 'Zulema Barrenechea', partyName: 'Renovación Popular', partyColor: COLORS.barrenechea, percentage: 9, photoUrl: PHOTOS.barrenechea, center: [-77.72, -9.8] },
      { province: 'RECUAY', label: 'Pamela Toro', partyName: 'País para Todos', partyColor: COLORS.toro, percentage: 7, photoUrl: PHOTOS.toro, center: [-77.44, -9.97] },
      { province: 'OCROS', label: 'Mary Melgarejo', partyName: 'Alianza Para el Progreso', partyColor: COLORS.melgarejo, percentage: 8, photoUrl: PHOTOS.melgarejo, center: [-77.42, -10.5] },
      { province: 'ASUNCION', label: 'Jesús Veliz', partyName: 'Fuerza Popular', partyColor: COLORS.veliz, percentage: 7, photoUrl: PHOTOS.veliz, center: [-77.39, -9.18] },
    ],
  },
  senadores: {
    'san-martin': [
