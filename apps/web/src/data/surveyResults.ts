...
> = {
  ...
  senadores: {
    ...
    ancash: [
      ...
      { name: 'Astencio Guevara', party: 'Ahora Nación', color: COLORS.ahoraNacion, percentage: 10, photoUrl: PHOTOS.guevara },
      { name: 'Jhonny Soto', party: 'País para Todos', color: COLORS.paisParaTodos, percentage: 9, photoUrl: PHOTOS.soto },
...
> = {
  ...
  senadores: {
    ...
    ancash: [
      ...
      { province: 'CARHUAZ', label: 'Astencio Guevara', partyName: 'Ahora Nación', partyColor: COLORS.guevara, percentage: 14, photoUrl: PHOTOS.guevara, center: [-77.56, -9.28] },
      ...
      { province: 'PALLASCA', label: 'Jhonny Soto', partyName: 'País para Todos', partyColor: COLORS.soto, percentage: 13, photoUrl: PHOTOS.soto, center: [-77.91, -8.35] },
      ...
      { province: 'SIHUAS', label: 'Astencio Guevara', partyName: 'Ahora Nación', partyColor: COLORS.guevara, percentage: 14, photoUrl: PHOTOS.guevara, center: [-77.58, -8.5] },
      ...
      { province: 'MARISCAL LUZURIAGA', label: 'Jhonny Soto', partyName: 'País para Todos', partyColor: COLORS.soto, percentage: 13, photoUrl: PHOTOS.soto, center: [-77.37, -8.9] },
      ...
      { province: 'RECUAY', label: 'Astencio Guevara', partyName: 'Ahora Nación', partyColor: COLORS.guevara, percentage: 14, photoUrl: PHOTOS.guevara, center: [-77.44, -9.97] },
